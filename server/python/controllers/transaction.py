...
PAYPAL_API_BASE_URL = os.getenv('PAYPAL_API_BASE_URL', 'https://api-m.sandbox.paypal.com') # use https://api-m.paypal.com for production environment
...
def get_client_token():
    try: 
            ...
            if PAYPAL_MERCHANT_ID:
                ...
                headers['PayPal-Auth-Assertion'] = get_auth_assertion_token(PAYPAL_CLIENT_ID, PAYPAL_MERCHANT_ID)
        ...
        try:
            ...
            if shipping_address:
                ...
                payload['purchase_units'][0]['shipping'] = {
                    ...
                    } if shipping_address_name.get('fullName') else None,
                    'address': {
                        'address_line_1': shipping_address['address']['addressLine1'],
                        'address_line_2': shipping_address['address']['addressLine2'],
                    ...
                    } if shipping_address_phone_number.get('countryCode') and 
                            shipping_address_phone_number.get('nationalNumber') else None
                }
